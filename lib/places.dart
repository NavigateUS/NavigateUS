...
Map<String, Place> nusLocations = {
  ...
  "Icube Building" : Place("Icube Building", const LatLng(1.2923243394779413, 103.77536909282506),
  ...
  "AS 7, The Shaw Foundation Building" : Place("AS 7, The Shaw Foundation Building",
  ...
  "Ventus" : Place("Ventus", const LatLng(1.295417875913936, 103.77022107162308)),
  "Kent Ridge Bus Terminal" : Place("Kent Ridge Bus Terminal",
      const LatLng(1.2943251047092783, 103.76978739220405)),
  "Eusoff Hall" : Place("Eusoff Hall", const LatLng(1.293853156333056, 103.77038820700811)),
  "Temasek Hall" : Place("Temasek Hall", const LatLng(1.2929808301017303, 103.77141905690885)),
  "Kent Ridge Hall" : Place(
      "Kent Ridge Hall", const LatLng(1.2919369247950556, 103.77478427720996)),
  "Sheares Hall" : Place("Sheares Hall", const LatLng(1.2915642455890586, 103.77565886220714)),
  ...
  "Innovation 4.0" : Place("Innovation 4.0", const LatLng(1.2943019163067662, 103.77593823603979)),
  "TCOMS" : Place("TCOMS", const LatLng(1.2936138096194254, 103.77693250500758)),
  "PGP Terminal" : Place("PGP Terminal", const LatLng(1.2918725303868497, 103.78050582390426)),
  ...
  "Raffles Hall" : Place("Raffles Hall", const LatLng(1.2999986193731659, 103.77335935677749)),
  ...
  "Engineering EA" : Place("Engineering EA", const LatLng(1.3005481307632891, 103.77074781610281)),
  "LT7" : Place("LT7", const LatLng(1.3003141010356785, 103.77108208019203)),
  "Engineering E1" : Place("Engineering E1", const LatLng(1.2989077012103507, 103.7710953910105)),
  "Engineering E2" : Place("Engineering E2", const LatLng(1.2991436749370524, 103.77126437016773)),
  "Engineering E3" : Place("Engineering E3", const LatLng(1.299520812859213, 103.77176607834234)),
  "Engineering E4" : Place("Engineering E4", const LatLng(1.2984307897929301, 103.77242420732959)),
  "E5, NUS Chemical & Biomolecular Engineering" : Place("E5, NUS Chemical & Biomolecular Engineering",
      const LatLng(1.2980609893199393, 103.77242101762776)),
  "Engineering E6" : Place("Engineering E6", const LatLng(1.2994199215102638, 103.77301366537175)),
  "Engineering E7" : Place("Engineering E7", const LatLng(1.2986631817063243, 103.7735123052119)),
  ...
  "NUS College of Design and Engineering, EA" : Place("NUS College of Design and Engineering, EA",
      const LatLng(1.3002767367745305, 103.77072694642754)),
  "LT6" : Place("LT6", const LatLng(1.2940999177172305, 103.77202501518539)),
  ...
  "LT33" : Place("LT33", const LatLng(1.2979804291146089, 103.78104550204267)),
  "LT35, Peter and Mary Fu Lecture Theatre" : Place("LT35, Peter and Mary Fu Lecture Theatre",
      const LatLng(1.2956339858521257, 103.78124630185256)),
  "LT36, Alice and Peter Tan Lecture Theatre" : Place("LT36, Alice and Peter Tan Lecture Theatre",
      const LatLng(1.2956339858521257, 103.78124630185256)),
  "The Deck" : Place("The Deck", const LatLng(1.2947174133627448, 103.77247781588338)),
  "Synchrotron Light Source" : Place("Synchrotron Light Source",
      const LatLng(1.295577005414589, 103.77487692321124)),
  "Institute of Materials Research & Engineering" : Place("Institute of Materials Research & Engineering",
  ...
  "Yong Siew Toh Conservatory of Music" : Place("Yong Siew Toh Conservatory of Music",
      const LatLng(1.302407446321917, 103.77274529465119)),
  "Lee Kong Chian Natural History Museum" : Place("Lee Kong Chian Natural History Museum",
      const LatLng(1.3015010937415459, 103.77351508858963)),
  "NUS Museum" : Place("NUS Museum", const LatLng(1.3013402027168905, 103.77270237930968)),
  "Music Library" : Place("Music Library", const LatLng(1.3018228757600563, 103.7728901339288)),
  ...
  "MPSH1,2,3,4" : Place("MPSH1,2,3,4", const LatLng(1.3008364254324378, 103.7759801877826)),
  "NUS Staff Club" : Place("NUS Staff Club", const LatLng(1.2992524085748836, 103.77584923471703)),
  ...
  "Institute For Mathematical Sciences" : Place("Institute For Mathematical Sciences",
  ...
  "LT32" : Place("LT32", const LatLng(1.2961023098254796, 103.77832192615465)),
  ...
  "Saw Swee Hock School of Public Health" : Place("Saw Swee Hock School of Public Health",
      const LatLng(1.2952043098334172, 103.78064516615078)),
  "LT21" : Place("LT21", const LatLng(1.2952043098334172, 103.78064516615078)),
  "Centre for Life Science" : Place("Centre for Life Science",
      const LatLng(1.2944024946076491, 103.78079045762864)),
  "Medical Library" : Place("Medical Library", const LatLng(1.2951861845665, 103.78180453651736)),
  ...
  "MD6, Centre for Translational Medicine" : Place("MD6, Centre for Translational Medicine",
  ...
  "Cendana College" : Place("Cendana College",
  ...
  "College of Alice & Peter Tan, CAPT" : Place("College of Alice & Peter Tan, CAPT",
  ...
  "School of Continuing and Lifelong Education" : Place("School of Continuing and Lifelong Education",
  ...
  "Create" : Place("Create", const LatLng(1.3039488322746062, 103.7740486452938)),
  "Stephen Riady Centre" : Place("Stephen Riady Centre",
      const LatLng(1.3045914718148488, 103.77259612913134)),
  "Saga College" : Place("Saga College", const LatLng(1.305860599197163, 103.77201966902363)),
  "Elm College" :Place("Elm College", const LatLng(1.3063724555706304, 103.77203545724225)),
};
